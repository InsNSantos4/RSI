...
soma = 0
cont = 0 #contador de numeros inseridos
while True:
    valor =int(input("Introduza um numero (negativo para terminar): "))
    if valor < 0:
        break
    cont += 1 # incrementar o contador de numeros inseridos
    if cont == 1: # 1º numero inserido. Vamos inicializar  maior e menor com este valor
       maior = valor
       menor = valor
